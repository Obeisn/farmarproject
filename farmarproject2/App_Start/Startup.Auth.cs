    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseMicrosoftAccountAuthentication(
                clientId: "2070d36e-da62-4d7b-82a3-621cac46fd5c",
                clientSecret: "F522B49450DD47DE363381046B3D7C2BB40261B8");
            ...
            app.UseFacebookAuthentication(
               appId: "1098329023673067",
               appSecret: "1efcf023e9cd3dfa85711131f7aa9611");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "17389846419-aj7ff8r64h1oe50n0p59encfm8tcu5gj.apps.googleusercontent.com",
                ClientSecret = "7qCQg7lo0Y73EINXyFIS_-UE"
            });
        }
    }
}